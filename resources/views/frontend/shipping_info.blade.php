            ...
            <form name="form1" id="form1" action="/order_confirm" method="POST" enctype="multipart/form-data">  
              ...
              <div class="form-group">
                <label for="recipient-name" class="col-form-label">Street Address</label>
                  ...
                  type="text" name="address" value="{{Auth::user()->address}}" autocomplete="off">
                @error('address')
        ...
        <div class="col-lg-5 col-md-5 col-12">
          <div class="card mx-auto order-summary-card">
            <div class="card-body">
             ...
             {{--  <p class="card-subtitle text-muted">{{count($cart_items)}} item in your cart</p> --}}
                <table class="table">
                  <thead class="theader">
                    <tr>
                  ...
                  <tbody class="tbody">
                    @foreach ($cart_items as $cart_item)
                      <tr>
                        ...
                        <td class="tdata text-muted" style="border-top: none;"> {{$cart_item->gallery->title}}
                         {{ number_format($cart_item->gallery->price) }}-kyats 
                        </td>
                      </tr>
                    @endforeach
                      <tr class="total-row">
                ...
                <div class="checkout_btn_inner d-flex align-items-center" style="float:right; margin: 0.5em 0;">
                  <button type="submit" class="button" id="submit_button" disabled>Place Order</button>
                </div>
